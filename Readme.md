...
The task is to develop a console-based Java application that manages contacts stored in the following format:
`name|mobile`

I have implemented operations such as adding, searching, listing contacts, and more.

**I chose option2 implementation approach**:
